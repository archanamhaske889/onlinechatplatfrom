        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href=" {{ url('/Visitor') }} "> <i class="menu-icon fa fa-dashboard"></i>Dashboard </a>
                    </li>
                   ...
                   <li class="menu-item-has-children dropdown">
                        ...
                        @endif
                         @if (Route::has('password.request'))
                                   <li><i class="menu-icon fa fa-paper-plane"></i> <a class="btn btn-link" href="{{ route('password.request') }}">
                ...
                <div class="col-sm-7">
                    ...
                    <div class="header-left">
                        ...
                        <div class="dropdown for-notification">
                           <a href=" {{ url('/chat') }} "><i class="fa fa-user"></i>Chat</a>
                        </div>
                        ...
                        <div class="dropdown for-message">
                            ...
                            <div class="dropdown-menu" aria-labelledby="message">
                                ...
                                <span class="message media-body">
                                    <span class="name float-left">Abbc</span>
                                ...
                                <span class="photo media-left"><img alt="avatar" ></span>
                                <span class="message media-body">
                                    <span class="name float-left">abc</span>
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        ...
                        <div class="user-menu dropdown-menu">
                            ...
                            <a class="nav-link" href="assets.home"><i class="fa fa-cog"></i> Data</a>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-flat-color-1">
                    <div class="card-body pb-0">
                        <div class="dropdown float-right">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                <div class="dropdown-menu-content">
                                    ...
                                    <a class="dropdown-item" href="#">Last 12 Month</a>
                                    <a class="dropdown-item" href="#">Custome Renge</a>
                                </div>
                            </div>
                        </div>
                        <h4 class="mb-0">
                        ...
                        <p class="text-light">Live Visitors</p>
          ...
          <div class="col-xl-6">
                    ...
                    <div class="twt-feed blue-bg">
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h2 class="text-white display-6">abc</h2>
            ...
            <div class="col-xl-3 col-lg-6">
                <div class="card">
                    <div class="card-body">
                        <div class="stat-widget-one">
                            <div class="stat-icon dib"><i class="ti-chat text-primary border-primary"></i></div>
                            <div class="stat-content dib">
                                <div class="stat-text">chat</div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="stat-widget-one">
                            <div class="stat-icon dib"><i class="ti-user text-primary border-primary"></i></div>
                            <div class="stat-content dib">
                                <div class="stat-text">Repoting</div>
                                <div class="stat-digit">961</div>
                            </div>
                        </div>
                    </div>
